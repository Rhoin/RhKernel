...
#define IRQ_SELECTOR 	ISR_SELECTOR 
#define IRQ_TYPE_ATTRIB ISR_TYPE_ATTRIB
...
/*
 * 
 * irq_handle : Remaps IRQ.Because IRQ0 to IRQ7 mapped to ISR8-15.8 which is Double Fault.So we have to remap it.
 * 
 */
